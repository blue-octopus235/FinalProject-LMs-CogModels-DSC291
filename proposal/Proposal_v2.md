...
3. Writing & Presentation  
   ...
   3. Writes results and discussion sections \[Sanjana\]  
   4. Presentation slides are split by topic to mirror report-section ownership — motivation/background \[Kelly\], methods \[Jackson\], results/discussion \[Sanjana\] — with Sanjana coordinating and assembling the deck.
